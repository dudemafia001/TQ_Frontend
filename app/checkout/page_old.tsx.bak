    ...
    <div className="checkout-container-mobile">
      ...
      <div className="checkout-content-mobile">
        ...
        <div className="address-section">
          <div className="section-header">
            ...
            <button className="change-address-btn" onClick={() => setShowLocationModal(true)}>
              Change Address
            </button>
          </div>
        ...
        <div className="delivery-time-section">
          ...
          <div className="delivery-info">
            ...
            <div className="delivery-time">
              Your order will be delivered on {deliveryDate || '07 Nov'} between 12:00 - 12:30
            </div>
          </div>
        </div>
            ...
            <div className="checkout-fixed-bottom">
              ...
              <div className="delivery-info-section">
                <div className="delivery-date-info">
                  <strong>Your order will be delivered on {deliveryDate || 'Loading...'}</strong>
                  <button className="schedule-later-btn">Schedule for later</button>
                </div>
      ...
      <PaymentModal 
        ...
        onSelectPayment={(method: string) => {
          ...
          // After selecting payment method, proceed with order
          handlePlaceOrder();
        }}
